    ...
    <nav className="bg-gray-200 shadow shadow-gray-300 w-full px-4 md:px-8">
      <div className="mx-auto container">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            {login ? (
              <button onClick={() => setLogin(false)} className="px-4 py-2 bg-sky-500 hover:bg-indigo-600 text-gray-50 rounded-xl flex items-center gap-2">
              ...
              <img onClick={() => setLogin(true)} src="/api/placeholder/50/50" alt="User" className="w-10 h-10 rounded-full border-2 border-black" />
            )}
          </div>
