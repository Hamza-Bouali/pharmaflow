...
const Nav= ({setPage}) => {
    ...
    const paths={'Dashboard':'/Dashboard','Inventory Management':'/inventory','Stock Forecasting':'/forecast','Order Management':'/orders','Reports':'/reports','Settings':'/settings'};
            ...
            <nav className="bg-gray-200 shadow shadow-gray-300 w-100 px-8 md:px-auto">
                <div className="md:h-16 h-28 mx-auto md:px-4 container flex items-center justify-between flex-wrap md:flex-nowrap">
                    <div className="text-indigo-500 md:order-1">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="blue">
